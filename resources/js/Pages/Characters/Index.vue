            ...
            <div class="flex mb-1 mx-2 items-end">
                ...
                <help-modal class="ml-2">
                    ...
                    <template #content>
                        ...
                        <p class="mb-4">
                            Characters can have actions, resources, spells, modifiers, etc. once they are created.  All stats can be rolled by click on them.  Using the dropdown next the a character's name, different sections of the character sheet can be shown/hidden as necessary.
                        </p>
                        <p class="mb-4">
