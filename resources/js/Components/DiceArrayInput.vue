<template>
    <div v-for="(object, index) in modelValue">
        <dice-input id="hit_dice" class="mt-1 inline-block" v-model:total="object.total" v-model:size="object.size" v-model:modifier="object.modifier" v-model:type="object.type" @input="$emit('update:modelValue', modelValue)"/>
